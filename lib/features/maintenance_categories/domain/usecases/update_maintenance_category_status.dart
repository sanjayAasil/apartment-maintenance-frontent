...
@injectable
class UpdateMaintenanceCategoryStatus {
  const UpdateMaintenanceCategoryStatus(this._repository);
  final MaintenanceCategoriesRepository _repository;
  Future<MaintenanceCategory> call(String id, bool isActive) =>
      _repository.updateCategoryStatus(id, isActive);
}
